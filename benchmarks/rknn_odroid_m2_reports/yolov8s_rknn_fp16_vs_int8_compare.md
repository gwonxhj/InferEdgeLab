...
- Base: `yolov8s.onnx` / `rknn` / `odroid_m2` / `20260421-090815`
- New: `yolov8s.onnx` / `rknn` / `odroid_m2` / `20260421-092207`
...
| Field | Base | New |
|---|---|---|
| runtime_artifact_path | /home/odroid/edgebench/runtime_models/yolov8s_fp16.rknn | /home/odroid/edgebench/runtime_models/yolov8s_hybrid_int8_presetB.rknn |
...
|---|---:|---:|---:|---:|
| mean_ms | 86.4330 | 49.0504 | -37.3825 | -43.25% |
| p99_ms | 107.7857 | 49.6924 | -58.0933 | -53.90% |
