...
| Runtime Intelligence risk summary | done | Orchestrator `operation_risk_rollup` / scheduler fairness context -> EdgeEnv handoff -> AIGuard deterministic evidence -> Lab deployment risk report |
