...
- Runtime Intelligence operation risk rollup chain: Orchestrator operation risk/timeline/scheduler fairness context -> EdgeEnv handoff -> AIGuard deterministic evidence -> Lab Runtime Intelligence Risk Summary.
...
| Runtime Intelligence rollup chain | `operation_risk_rollup` / scheduler fairness -> EdgeEnv handoff -> AIGuard evidence -> Lab Risk Summary |
