...
It also emits `Validated Policy Pressure` with the policy-pressure
reason-count marker, so overload reason preservation remains visible in the
gate summary.
